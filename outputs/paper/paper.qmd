...
# Introduction
Household income is defined as the gross income earned by all members in a household above 15 years of age (https://www.investopedia.com/terms/h/household_income.asp). Over the years, it has been debated whether household incomes at all affect one’s affiliation toward a political school of thought. It is a reasonable hypothesis to assume a sort of relationship between income and voting either Democrat or Republican, as both parties have different economic outlooks thereby affecting incomes differently. Presumably, a higher income inequality polarizes political leaning further. Therefore it is in our best interests to study whether the economically disadvantaged vote to improve their quality of life. 
 
In ‘Income Inequality and Partisan Voting in the United States’, Andrew Gelman, Lane Kenworthy and Yu-Sung Su (https://www.jstor.org/stable/42956457?seq=11) make a case for higher earning Americans voting Republican, whereas Jeff Madrick (https://www.nytimes.com/2020/07/31/books/review/the-system-robert-reich-break-em-up-zephyr-teachout.html) argues how working-class Americans voted supposedly against their interests in voting Republican. Conflicting theories have emerged, and we intend to tackle this issue at hand of whether different income brackets tend to vote differently. 
